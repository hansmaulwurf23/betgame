...
import util.log4j.IColorScheme;
...
public class ANSIPatternLayout extends PatternLayout {
    ...
    public static final String DEFAULT_COLOR_FATAL      = IColorScheme.FATAL_COLOR;
    public static final String DEFAULT_COLOR_ERROR      = IColorScheme.ERROR_COLOR;
    public static final String DEFAULT_COLOR_WARN       = IColorScheme.WARN_COLOR;
    public static final String DEFAULT_COLOR_INFO       = IColorScheme.INFO_COLOR;
    public static final String DEFAULT_COLOR_DEBUG      = IColorScheme.DEBUG_COLOR;
    public static final String DEFAULT_COLOR_TRACE      = IColorScheme.TRACE_COLOR;
    public static final String DEFAULT_COLOR_ALL        = IColorScheme.DEFAULT_COLOR;
    public static final String DEFAULT_COLOR_RESET      = IColorScheme.END_COLOR;
    public static final String DEFAULT_COLOR_STACKTRACE = IColorScheme.ERROR_COLOR;
    public static final String DEFAULT_COLOR            = IColorScheme.DEFAULT_COLOR;

    public ANSIPatternLayout() {
        setDefaultColors();
    }

    public ANSIPatternLayout(String string) {
        super(string);
        setDefaultColors();
    }
    ...
    /**
     *  Trace - color string for trace events.  Default is blue.
     */
