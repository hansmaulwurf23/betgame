...
logger('grails.app.services.grails.plugin.gscripting',  DEBUG, usedAppenders, false)
logger('grails.app.controllers.de.betgame',  DEBUG, usedAppenders, false)
logger('grails.app.services', DEBUG, usedAppenders, false)
logger('grails.app.controllers.betgame',  DEBUG, usedAppenders, false)
